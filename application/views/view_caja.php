<link rel="stylesheet" href="application/assets/css/caja.css">
    ...
    <div class="row">
        <div class="wrap col-8">
            ...
            <div class="content">
                <div class="card">
                    <section id="one">
                        <table id="table_listaProductos" class="display">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Nombre</th>
        ...
        <div class="wrap col-4" id="carro">
            <h3 class="text-center mt-3">LISTA DE COMPRA</h3>
            <div class="card" id="carrito">
                <h2>LISTA VACÍA</h2>
            </div>
        </div>
    </div>
